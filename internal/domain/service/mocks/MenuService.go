...
func (_m *MenuService) GetMenu(id int64) (*entity.Response, error) {
	ret := _m.Called(id)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(int64) (*entity.Response, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(int64) *entity.Response); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
