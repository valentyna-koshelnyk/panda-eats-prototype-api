...
func (_m *RestaurantService) FilterRestaurants(category string, zip string, priceRange string) (*entity.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string) (*entity.Response, error)); ok {
		return rf(category, zip, priceRange)
	}
	if rf, ok := ret.Get(0).(func(string, string, string) *entity.Response); ok {
