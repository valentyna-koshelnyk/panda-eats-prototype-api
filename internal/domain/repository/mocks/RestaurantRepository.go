...
type mockConstructorTestingTNewRestaurantRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewRestaurantRepository(t mockConstructorTestingTNewRestaurantRepository) *RestaurantRepository {
